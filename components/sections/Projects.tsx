    ...
    <div className="container mx-auto px-4 sm:px-6">
        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="aspect-video relative overflow-hidden">
              ...
              {/* Tech Stack Icons */}
              <div className="absolute top-3 sm:top-4 right-3 sm:right-4 flex gap-1.5 sm:gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                {project.iconLists.slice(0, 3).map((icon, iconIndex) => (
                  <div
                    key={iconIndex}
                    className="w-7 h-7 sm:w-8 sm:h-8 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center border border-white/30"
                  >
                    <Image
                      src={icon}
                      alt="tech"
                ...
                {project.iconLists.length > 3 && (
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center border border-white/30 text-white text-xs font-bold">
                    +{project.iconLists.length - 3}
                  </div>
                )}
              </div>
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-4 sm:mb-6">
                {project.iconLists.slice(0, 4).map((icon, iconIndex) => (
                  <div
                    key={iconIndex}
                    className="w-5 h-5 sm:w-6 sm:h-6 bg-white/10 rounded flex items-center justify-center"
                  >
                    <Image
                      src={icon}
                      alt="tech"
              ...
              <div className="flex gap-2 sm:gap-3">
                <Button
                  variant="outline"
                  size="sm"
                  className="flex-1 border-white/20 text-white hover:bg-white/10 hover:border-white/40 transition-all duration-200 text-xs sm:text-sm"
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="px-2 sm:px-3 bg-white/5 hover:bg-white/10 text-white border border-white/20"
                >
      ...
      >
        <Button
          variant="outline"
          size="lg"
          className="border-white/30 text-white hover:bg-white/10 hover:border-white/50 px-6 sm:px-8 py-2.5 sm:py-3 text-base sm:text-lg font-semibold"
        >
